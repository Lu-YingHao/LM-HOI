...
def main(args):
    ...
    clip_model, _ = clip.load_from_name("ViT-B-16", device="cpu", download_root="./")
    ...
    def build_optimizer(model):
        ...
        for n, p in model.named_parameters():
            ...
            # 确保alpha参数被包含在更新参数中
            if 'hoi' in n or 'bbox' in n or 'promp_proj' in n or "vision_proj" in n or 'gate_weight' in n or 'dgw_' in n or 'alpha' in n or 'adapter' in n or 'beta' in n:
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(model, criterion, data_loader_train, optimizer,
                                    device, args.dataset_file,epoch, args.clip_max_norm,clip_model=clip_model)
