...
def get_args_parser():
    ...
    # Feature Buffer Settings
    parser.add_argument('--enable_feature_buffer', default=False, type=lambda x: (str(x).lower() == 'true'),
                       help='whether to enable feature buffer for cross-batch information')
    parser.add_argument('--buffer_size', default=1000, type=int,
                       help='size of feature buffer')
